...
function main() {
  ...
  parser.addArgument(["--minify"], { action: "storeTrue", defaultValue: true })
  parser.addArgument(["--chromeapp"], {
    action: "storeTrue",
    defaultValue: false,
  })
  parser.addArgument(["--persist"], {
    action: "storeTrue",
    defaultValue: false,
  })
