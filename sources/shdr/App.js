...
(function() {
  ...
  App = (function() {
    ...
    App.prototype.updateShader = function() {
      var line, msg, ok, ref, session, src, type;
    ...
    App.prototype.initDocuments = function(obj) {
      var _fs, _vs, fl, fm, fs, ref, ref1, vl, vm, vs;
    ...
    App.prototype["new"] = function() {
      var obj;
      obj = {
        documents: [shdr.Snippets.TestailuFragment, shdr.Snippets.TestailuVertex],
        name: 'Untitled'
      };
      this.initDocuments(obj);
      this.ui.setStatus('Editor reset using default shaders.', shdr.UI.SUCCESS);
      this.ui.clearName('Untitled');
      return loadModel('models/zeukkari16.js');
    };
